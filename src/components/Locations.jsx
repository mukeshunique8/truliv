...
<div className={`relative bg-sbg mb-[500px] justify-center  items-center w-full flex flex-col ${
    houseType === "Co-Living Spaces" ? "pt-[350px] md:pt-0" :
    houseType === "Holiday Homes" ? "pt-[480px]  md:pt-0" :
    ""
}`}>
    ...
    className="relative w-full max-w-[1440px]  pb-[125px] md:pb-[175px] bg-sbg z-40 rounded-b-[75px] md:rounded-b-[25%] pt-[54px] md:px-[44px] gap-y-4 md:gap-y-[33px] md:flex-wrap flex gap-x-3 justify-center md:justify-evenly h-fit overflow-y-hidden flex-row overflow-x-scroll md:overflow-auto scrollbar-hide ">
...
simgh="110"
  ...
  />
     ...
     <div className={`${
    houseType === "Holiday Homes" ? "absolute w-full top-[1000px] md:top-[1080px]" :
    houseType === "Co-Living Spaces" ? "absolute w-full top-[1330px] md:top-[880px]" :
