...
export default function NearbyPropertiesCard(props) {
  ...
  function routeProperty() {
    router.push("/properties/CLpropertiesDetails");
  }

  const amenities = [
    { icon: "/furniture3.svg", text: "Single, Double & Triple" },
    { icon: "/unisex.svg", text: "Wi-fi" },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col px-2 md:hidden justify-start gap-y-2">
        ...
        {props.price}<span className="text-[#707070] font-normal text-base">/ month</span>
        </p>
      </div>
