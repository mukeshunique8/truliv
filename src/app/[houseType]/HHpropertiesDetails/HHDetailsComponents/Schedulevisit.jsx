...
export default function ScheduleVisit() {
  ...
  return (
    <div className="w-full md:hidden h-full flex flex-col justify-center items-center rounded-lg   bg-green-400">
      ...
      <div className=" mt-4 w-full justify-around flex items-center j">
        <h2 className="  text-ptxt text-2xl">
          {activeButton === "visit"
            ? "Schedule A Visit"
      ...
      <div className="mt-[27px] gap-y-3 flex flex-col px-5 ">
        ...
        {activeButton === "visit" && (
          <div className="flex w-full ">
            ...
            >
              <option value="Single Occupancy">1234</option>
              <option value="Double Occupancy">1234</option>
              <option value="Triple Occupancy">1234</option>
              <option value="Quadruple Occupancy">1234</option>
              <option value="Quintuple Occupancy ">1234</option>
            </Select>
          </div>
        )}
        ...
        <div className="flex pr-8">
          ...
          <div>
            <p className="text-[#000000] text-base leading-6">
            I have read and agreed to the <span className="text-ptxt underline"> House Rules & Policies</span>
            </p>
          </div>
        </div> */}
